...
oraid keys add validator1 --keyring-backend=test --home=$HOME/.oraid/validator1 > $HIDE_LOGS 2>&1
oraid keys add validator2 --keyring-backend=test --home=$HOME/.oraid/validator2 > $HIDE_LOGS 2>&1
oraid keys add validator3 --keyring-backend=test --home=$HOME/.oraid/validator3 > $HIDE_LOGS 2>&1
