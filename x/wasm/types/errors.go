...
var (
	...
	ErrSetGaslessFailed = errorsmod.Register(DefaultCodespace, 29, "setting gasless contract failed")

	// ErrUnsetGaslessFailed error for unsetting gasless contract failures
	ErrUnsetGaslessFailed = errorsmod.Register(DefaultCodespace, 30, "unsetting gasless contract failed")
)
